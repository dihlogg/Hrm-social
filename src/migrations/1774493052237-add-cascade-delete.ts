...
export class AddCascadeDelete1774493052237 implements MigrationInterface {
    name = 'AddCascadeDelete1774493052237'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ReactionCounts" ADD CONSTRAINT "FK_93a698ebf0ffe681f067ac5c0d5" FOREIGN KEY ("postId") REFERENCES "Posts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ReactionCounts" ADD CONSTRAINT "FK_72055ac6eab60d1957eafcd28d2" FOREIGN KEY ("postCommentId") REFERENCES "PostComments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "PostComments" ADD CONSTRAINT "FK_f6f327ec68b7f0259126fa8c053" FOREIGN KEY ("parentId") REFERENCES "PostComments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Reactions" ADD CONSTRAINT "FK_cf2018739f90313e8f7b39c4b39" FOREIGN KEY ("postId") REFERENCES "Posts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Reactions" ADD CONSTRAINT "FK_7db18ecc70e9e59b95add5a7725" FOREIGN KEY ("postCommentId") REFERENCES "PostComments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
